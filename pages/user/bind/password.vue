<template>
	<view>
		<view class="a-mx-5 a-overflow-hidden a-bg-orange-yellow-lighter a-rounded-2  a-mt-3 forms-border-bottom">
			
			<!-- 手机号 -->
			<view v-if="isForgot" class="a-flex a-align-center a-rounded-circle a-h-90 a-mt-5">
				<text class="a-font a-ml-3 a-font-weight-bold">{{$t('form.account')}}</text>
				...
				<input class="a-flex-1 a-h-90 a-rounded-circle a-px-4 a-font" type="number" v-model="form.mobile" :placeholder="$t('placeholder.phone')" placeholder-class="a-text-gray-light" />
			</view>
			
			  <!-- 验证码 -->
			  <view class="a-flex a-align-center a-h-90 a-my-3 forms-border-bottom">
				  <view class="a-ml-3 a-flex-column a-w-200 ">
					  <text class="a-font a-font-weight-bold">{{$t('form.verificationCode')}}</text>
				  </view>
				
				<input class="a-flex-1 a-h-90 a-rounded-circle a-px-4 a-font" type="number" v-model="form.smsCode"  :placeholder="$t('placeholder.Sms')" placeholder-class="a-text-gray-light" />
			  ...
			  <view class="a-flex a-align-center a-rounded-1-5 a-h-90 a-mt-2 forms-border-bottom">
					<text class="a-font a-ml-3 a-font-weight-bold a-w-200">{{$t('form.newPassword')}}</text>
					<input class="a-flex-1 a-h-90 a-px-4 a-font" type="text" v-model="form.password"  :placeholder="$t('placeholder.password')" placeholder-class="a-text-gray-light" />
			  </view>
			  
			  <!-- 密码 -->
			  <view class="a-flex a-align-center a-rounded-1-5 a-h-90 a-mt-2 forms-border-bottom">
					<text class="a-font a-ml-3 a-font-weight-bold a-w-200">{{$t('form.confirmation')}}</text>
					<input class="a-flex-1 a-h-90 a-px-4 a-font" type="text" v-model="form.passwords"  :placeholder="$t('placeholder.password')" placeholder-class="a-text-gray-light" />
			  </view>
