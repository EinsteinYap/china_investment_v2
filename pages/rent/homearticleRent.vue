		...
		<view class="a-mx-3 a-mb-3 a-bg-primary-op-3 a-rounded-1-5">
			<view class="a-p-3">
				...
				<view class="a-flex a-align-center a-justify-between a-mt-2">
					<text class="a-text-white a-font-sm">{{$t('pro.amount')}}:</text>
					<text class="a-text-white a-font-sm">{{detail.goods_price}} Rs</text>
				</view>
				<view v-if="detail.settle_model !=3" class="a-flex a-align-center a-justify-between a-mt-2">
					...
					<text class="a-text-white a-font-sm">{{detail.daily_income}} Rs</text>
				</view>
				<view class="a-flex a-align-center a-justify-between a-mt-2">
					<text class="a-text-white a-font-sm">{{$t('pro.incomeCycle')}}:</text>
					<text class="a-text-white a-font-sm">{{detail.total_day}} Days</text>
				</view>
				<view class="a-flex a-align-center a-justify-between a-mt-2">
					<text class="a-text-white a-font-sm">{{$t('pro.totalIncome')}}:</text>
					<text class="a-text-white a-font-sm">{{detail.total_profit}} Rs</text>
				</view>
				<view class="a-flex a-align-center a-justify-between a-mt-2">
					<text class="a-text-white a-font-sm">{{$t('pro.purchaseLimit')}}:</text>
					<text class="a-text-white a-font-sm">{{detail.limit_num}}</text>
				</view>
				<view v-if="detail.expire_time" class="a-flex a-align-center a-justify-between a-mt-2">
					<text class="a-text-white a-font-sm">{{$t('pro.eventcountdown')}}:</text>
